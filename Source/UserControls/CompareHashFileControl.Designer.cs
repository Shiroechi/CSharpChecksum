namespace CSharpChecksum.UserControls
{
	partial class CompareHashFileControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.BrowseTextFileButton = new System.Windows.Forms.Button();
			...
			this.HashProgressBar.TabIndex = 23;
			// 
			...
			this.HashFunctionListComboBox.TabIndex = 22;
			// 
			// CancelHashButton
			// 
			...
			this.CancelHashButton.TabIndex = 21;
			...
			// 
			this.BrowseTextFileButton.Location = new System.Drawing.Point(500, 148);
			this.BrowseTextFileButton.Name = "BrowseTextFileButton";
			this.BrowseTextFileButton.Size = new System.Drawing.Size(100, 30);
			this.BrowseTextFileButton.TabIndex = 18;
			this.BrowseTextFileButton.Text = "Open Text";
			this.BrowseTextFileButton.UseVisualStyleBackColor = true;
			this.BrowseTextFileButton.Click += new System.EventHandler(this.BrowseTextFileButton_Click);
			// 
			// HashValueTextBox
			// 
			...
			this.Controls.Add(this.BrowseTextFileButton);
		...
		private System.Windows.Forms.Button BrowseTextFileButton;
